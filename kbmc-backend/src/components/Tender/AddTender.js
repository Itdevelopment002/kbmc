...
const AddTender = () => {
  ...
  const handleAddTender = async (e) => {
    ...
    // Ensure status is set to '-' if not marked as 'New'
    const updatedTender = {
      ...newTender,
    ...
    try {
      ...
      setErrors({ ...errors, general: "Failed to add tender. Please try again." });
    }
  };
                  ...
                  <div className="card-block">
                    <form onSubmit={handleAddTender}>
                      <div className="form-group row">
                        <label htmlFor="description" className="col-form-label col-md-2">
                      ...
                      <div className="form-group row">
                        <label htmlFor="status" className="col-form-label col-md-2">
                      ...
                      <div className="form-group row">
                        <label htmlFor="pdf" className="col-form-label col-lg-2">
                          Upload Tender PDF <span className="text-danger">*</span>
                        </label>
                        <div className="col-md-4">
