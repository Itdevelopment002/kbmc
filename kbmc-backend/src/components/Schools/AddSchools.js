                        ...
                        <div className="card-box">
                            <div className="card-block">
                                ...
                                <form onSubmit={handleSchoolSubmit}>
                                    ...
                                    <div className="form-group row">
                                        <label className="col-form-label col-md-3">School Name <span className="text-danger">*</span></label>
                                        <div className="col-md-5">
                                            <input
                                                type="text"
                                                className={`form-control form-control-md ${errors.schoolName ? "is-invalid" : ""}`}
                                                name="schoolName"
                                    ...
                                    <div className="form-group row">
                                        <label className="col-form-label col-md-3">Medium <span className="text-danger">*</span></label>
                                        <div className="col-md-5">
                                            <select
                                                className={`form-control form-control-md ${errors.medium ? "is-invalid" : ""}`}
                                                name="medium"
