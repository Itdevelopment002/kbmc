...
const AddElectric = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/electric'); // Redirect on success
        } catch (err) {
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-md-5">
                                                ...
                                                />
                                                {errors.heading && <div className="text-danger mt-1">{errors.heading}</div>}
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-md-5">
                                                ...
                                                />
                                                {errors.vendorName && <div className="text-danger mt-1">{errors.vendorName}</div>}
                                            </div>
                                        </div>
