  ...
  return (
    <Router>
      {!isAuthenticated ? (
        ...
        <>
          <Header onLogout={handleLogout} /> {/* Show Header when logged in */}
          <div className="d-flex" style={{ margin: 0 }}>
            <Sidebar /> {/* Show Sidebar when logged in */}
              ...
              <div className="p-4 flex-grow-1">
                <Routes>
                  ...
                  <Route
                    ...
                    element={<MunicipalProperties />}
                  />
                  <Route
                    path="/add-municipal"
                    element={<AddMunicipalProperties />}
                  />
                  ...
                  <Route
                    path="/add-school-images"
                    element={<AddSchoolImages />}
                  />
                  ...
                  <Route
                    path="/previous-president"
                    element={<PreviousPresident />}
                  />
                  <Route
                    path="/add-previous-president"
                    element={<Add_PreviousPresident />}
                  />
                  <Route
                    path="/previous-chief-officer"
                    element={<PreviousChiefOfficer />}
                  />
                  <Route
                    path="/add-previous-chief-officer"
                    element={<Add_previouschiefofficer />}
                  />
                  <Route path="/elected-wings" element={<Electedwings />} />
                  <Route
                    path="/add-elected-wings"
                    element={<Add_electedwings />}
                  />
                  ...
                  <Route
                    path="/add-website-link"
                    element={<Add_websitelink />}
                  />
                  <Route
                    path="/general-department"
                    element={<Generaladmindepartment />}
                  />
                  <Route
                    path="/add-general-dep-year"
                    element={<Add_gernaldepyear />}
                  />
                </Routes>
              </div>
            </div>
