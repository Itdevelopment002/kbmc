                      ...
                      <div className="col-md-4">
                        <input
                          ...
                          className={`form-control form-control-md ${
                            errors.serviceHeading ? "is-invalid" : ""
                          }`}
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-md-4">
                        <input
                          ...
                          name="mainIcon"
                          className={`form-control form-control-md ${
                            errors.mainIcon ? "is-invalid" : ""
                          }`}
                          accept="image/*"
                          onChange={(e) =>
                            handleFileChange(e, setMainIcon, "mainIcon")
                          }
                        />
                        {errors.mainIcon && (
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-md-4">
                        <input
                          ...
                          name="hoverIcon"
                          className={`form-control form-control-md ${
                            errors.hoverIcon ? "is-invalid" : ""
                          }`}
                          accept="image/*"
                          onChange={(e) =>
                            handleFileChange(e, setHoverIcon, "hoverIcon")
                          }
                        />
                        {errors.hoverIcon && (
                          <span className="text-danger">
